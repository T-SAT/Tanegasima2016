...
void skLPSxxx::SetOriginPressureValue(float origin_pressure)
{
    OriginPressure = origin_pressure;
}
/*******************************************************************************
...
float skLPSxxx::GetAltitude(float current_pressure)
{
    return(AltitudeCalc(OriginPressure, current_pressure));
}
